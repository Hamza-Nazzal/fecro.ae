...
export default function OrderDetailsForm({ orderDetails, updateOrderDetails }) {
  ...
  const dlError = orderDetails?._touchedDeadline && dlMissing ? "Quote deadline is required" : "";
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        <div>
          <RequiredLabel htmlFor="rfq-deadline"> Request For Quotation is valid for</RequiredLabel>
          <select
            id="rfq-deadline"
            className={`w-full p-3 border rounded-lg focus:ring-2 ${
              dlError
                ? `border-red-600 bg-red-50 focus:ring-red-600 ${shouldBlink ? "animate-pulse" : ""}`
